...
enum SemaError: Error, CustomStringConvertible {
    ...
    case typeDoesNotConform(typeName: Identifier, protocol: Identifier)
    case missingImplementation(signature: String)
    ...
    var description: String {
        ...
        case .missingImplementation(let signature):
            return "missing implementation for '\(signature)'"
        }
    }
}
